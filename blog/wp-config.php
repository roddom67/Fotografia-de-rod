...
$sDestDir = '/home/fotorodi/public_html/blog';
if ( substr($sDestDir, 0, 1) == "\\" ) {
      $sDestDir = "\\".$sDestDir ;
}
define( 'WPCACHEHOME', '/home/fotorodi/public_html/blog/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager

/** El nombre de tu base de datos de WordPress */
define('DB_NAME', 'fotorodi_blog');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'fotorodi_blog');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'pizmrgnvvxedv0R');
